        ...
        <>
            {
                ...
                <div className={'bg-gray-500 h-full absolute z-40 top-0 right-0 min-h-200 w-screen bg-secondary-17 bg-opacity-40'}
                    ...
                    <aside id="separator-sidebar"
                           ...
                           aria-label="Sidebar">
                        <div className="py-4 overflow-y-auto text-secondary-light divide-y-2">
                                        ...
                                        <li key={item.label}>
                                            <a href={`${item.path}`}
                                               className={'flex items-center px-6 py-4 hover:bg-primary-01 ' +
                                                   'hover:text-primary hover:border-r-2 hover:border-primary ' +
                                                   'group active:text-primary active:border-r-2 active:border-primary'}>
